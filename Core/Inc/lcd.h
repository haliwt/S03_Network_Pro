...
#define LCD_BACK_LIGHT_ON()				HAL_GPIO_WritePin(LCD_BACK_LIGHT_GPIO_Port, LCD_BACK_LIGHT_Pin,GPIO_PIN_SET)
#define LCD_BACK_LIGHT_OFF()            HAL_GPIO_WritePin(LCD_BACK_LIGHT_GPIO_Port,LCD_BACK_LIGHT_Pin,GPIO_PIN_RESET)
